# THIS IS A TEST VERSION! Use at your own risk!
...
1. Head to [Release](https://github.com/XxBAJNOKxX/Microsoft-Reward-Chrome-Ext/releases) and download the latest Source code (zip).
...
![greyLogo](https://github.com/XxBAJNOKxX/Microsoft-Reward-Chrome-Ext/blob/master/src/img/grey@1x.png?raw=true) - Just hang on a second. The extension will start to work soon.

![blueLogo](https://github.com/XxBAJNOKxX/Microsoft-Reward-Chrome-Ext/blob/master/src/img/busy@1x.png?raw=true) - Working hard on doing those search quests for ya!

![greenLogo](https://github.com/XxBAJNOKxX/Microsoft-Reward-Chrome-Ext/blob/master/src/img/done@1x.png?raw=true) - Congratulations! You have completed all quests for today.

![yellowLogo](https://github.com/XxBAJNOKxX/Microsoft-Reward-Chrome-Ext/blob/master/src/img/warn@1x.png?raw=true) - Attention! You still have some points to earn through quests.

![redLogo](https://github.com/XxBAJNOKxX/Microsoft-Reward-Chrome-Ext/blob/master/src/img/err@1x.png?raw=true) - Oops... an error occurred - Check out [Troubleshooting](TROUBLESHOOTING.md).
